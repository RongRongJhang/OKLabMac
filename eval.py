...
if __name__ == '__main__':
    if not os.path.exists('/content/drive/MyDrive/OKLabMac/output'):
        os.mkdir('/content/drive/MyDrive/OKLabMac/output')  
    ...
    if ep.lol:
        eval_data = DataLoader(dataset=get_eval_set("/content/drive/MyDrive/OKLabMac/datasets/LOLdataset/eval15/low"), num_workers=num_workers, batch_size=1, shuffle=False)
        output_folder = '/content/drive/MyDrive/OKLabMac/output/LOLv1/'
        if ep.perc:
            weight_path = '/content/drive/MyDrive/OKLabMac/weights/LOLv1/w_perc.pth'
        else:
            weight_path = '/content/drive/MyDrive/OKLabMac/weights/LOLv1/wo_perc.pth'
